...
import java.util.*;
/**Vaendremos los 3 coeficientes como atributos, llamémosles a, b y c.
 * Hay que insertar estos 3 valores para construir el objeto a través de un método constructor.
 * Luego,mos a realizar una clase llamada Raices, donde representaremos los valores de una ecuación de 2º grado. 
 ...
 * @author chuki
 */
import Raiceservicio.Raiceservicio;
...
public class extra01 {
  ...
  Raiceservicio rs = new Raiceservicio(); // inicializamos el servicio 
